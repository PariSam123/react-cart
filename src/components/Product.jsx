  ...
  return (
    <div className='container'>
      <div className="row mt-5">
        ...
        <div className="col-md-6">
          <h4 className="display-4 text-center text-uppercase text-secondary">Product {product.title} </h4>
          <div className='d-flex justify-content-between'>
            <h5>
              <strong>Price</strong>
              <span className='text-warning'> &#8377;
                <ins className='text-success'>  {Math.round(product.price - (product.price * (product.discountPercentage/100)))} </ins> 
