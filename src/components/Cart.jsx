            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12 text-center">
                        <h3 className="display-3 text-secondary">Your Cart is Empty</h3>
                    </div>
                </div>
            </div>
        )
                            ...
                            cart.map((item,index) => {
                                ...
                                return(
                                    <tr className='text-center' key={index}>
                                        <td> {title} </td>
                                        <td>
                                            <img src={thumbnail} alt="no product image" className='img-fluid' style={{width: '40px'}} />
                                        </td>
                                        <td> &#8377;
                                        ...
                                        <td>
                                            <span onClick={() => decrement(id)} className='text-danger me-2' style={{cursor: 'pointer'}}>
                                                <i className='bo bi-dash-circle'></i>
                                            </span> 
